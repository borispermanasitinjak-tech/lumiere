...
<div class="container" style="padding: 40px 20px;">
    ...
    <div class="card" style="max-width: 800px; margin: 0 auto;">
        <h2>Edit Product</h2>
        <form action="<?php echo BASE_URL; ?>/admin/edit_product/<?php echo $data['id']; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <?php if(!empty($data['image'])): ?>
                    <img src="<?php echo $data['image']; ?>" alt="Product Image" style="max-width: 150px; border-radius: 5px; margin-bottom: 10px;">
                <?php else: ?>
                    <p>No image set</p>
                <?php endif; ?>
